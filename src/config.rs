...
use crate::config::keys as config_keys;
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.o0oo.cc"];
pub const RS_PUB_KEY: &str = "iX24yM7eConytud9YSInVdeU3syPIHJodVl9+ZKIz20=";
